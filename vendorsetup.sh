...
echo "delete hals"
git clone https://github.com/LineageOS/android_external_rsync -b lineage-20.0 external/rsync
git clone https://github.com/LineageOS/android_external_zstd -b lineage-20.0 external/zstd
...
git clone https://github.com/SebaUbuntu/android_packages_apps_Aperture -b lineage-20.0 packages/apps/Aperture
echo "cloned hals"
